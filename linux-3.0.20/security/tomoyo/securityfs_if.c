...
static int __init tomoyo_initerface_init(void)
{
	...
	tomoyo_create_entry("check_performance",    0600, tomoyo_dir,
	                                         TOMOYO_HOOKS_CALLTIME_CONTROL);

	tomoyo_create_entry("hooks_calltime",    0600, tomoyo_dir,
		                                TOMOYO_HOOKS_CALLTIME);
#endif
#ifdef CONFIG_SECURITY_TOMOYO_DISABLE
    tomoyo_create_entry("tomoyo_enable",    0600, tomoyo_dir,
                TOMOYO_ENABLE);    
#endif
