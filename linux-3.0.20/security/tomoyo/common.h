...
enum tomoyo_securityfs_interface_index {
	...
	TOMOYO_QUERY,
#ifdef CONFIG_SECURITY_DEBUG
	TOMOYO_HOOKS_CALLTIME_CONTROL,
	TOMOYO_HOOKS_CALLTIME,
#endif
...
enum tomoyo_operations {
	...
	TOMOYO_NETWORK_INET,
	TOMOYO_NETWORK_UNIX,
	TOMOYO_MANUAL_TASK_ACL,
	TOMOYO_MAX_OPERATIONS
};
...
/* Index numbers for policy controller. */
enum tomoyo_policy_control_type {
	TOMOYO_POLICY_WRITER,
	TOMOYO_POLICY_READER,
	TOMOYO_LOG_READER
};
...
struct tomoyo_domain_info {
	struct list_head list;
	struct list_head acl_info_list[TOMOYO_MAX_OPERATIONS];
...
/* Structure for "restrict_privilege" keyword. */

#ifdef CONFIG_SECURITY_TOMOYO_RESTRICT_PRIVILEGE

struct tomoyo_restrict_privilege {
        struct tomoyo_acl_head head;
        bool is_last_name;
        const struct tomoyo_path_info *domainname; /* Maybe NULL */
        uid_t uid;
...
int tomoyo_write_file(struct tomoyo_acl_param *param, void *acl_data, const bool is_acl_group);
int tomoyo_write_group(struct tomoyo_acl_param *param, const u8 type);
int tomoyo_write_misc(struct tomoyo_acl_param *param, void *acl_data, const bool is_acl_group);
int tomoyo_write_inet_network(struct tomoyo_acl_param *param, void *acl_data, const bool is_acl_group);
int tomoyo_write_transition_control(struct tomoyo_acl_param *param,
				    const u8 type);
int tomoyo_write_unix_network(struct tomoyo_acl_param *param, void *acl_data, const bool is_acl_group);
...
extern const u8 tomoyo_p2operation[TOMOYO_MAX_PATH_OPERATION];
extern const u8 tomoyo_pn2operation[TOMOYO_MAX_PATH_NUMBER_OPERATION];
extern const u8 tomoyo_pnnn2operation[TOMOYO_MAX_MKDEV_OPERATION];
extern const u8 tomoyo_pp2operation[TOMOYO_MAX_PATH2_OPERATION];
