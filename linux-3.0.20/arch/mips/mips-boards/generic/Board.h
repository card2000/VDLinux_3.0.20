...
#define IR_TCL_RCA                  23

#define IR_TYPE_TOSHIBA             50
...
#if defined(CONFIG_MSTAR_TITANIA13_BD_FPGA) || defined(CONFIG_MSTAR_AMBER1_BD_FPGA) || defined(CONFIG_MSTAR_EMERALD_BD_FPGA)
    #define MS_BOARD_TYPE_SEL       BD_FPGA
#elif defined(CONFIG_MSTAR_TITANIA13_BD_GENERIC) || defined(CONFIG_MSTAR_AMBER1_BD_GENERIC) || defined(CONFIG_MSTAR_EMERALD_BD_GENERIC)
