...
#if (defined(CONFIG_MSTAR_AMBER1_MMAP_128MB_128MB) || defined(CONFIG_MSTAR_EMERALD_MMAP_128MB_128MB))
#include "mmap/mmap_128mb_128mb.h"
#elif (defined(CONFIG_MSTAR_AMBER1_MMAP_256MB_256MB) || defined(CONFIG_MSTAR_EMERALD_MMAP_256MB_256MB))
