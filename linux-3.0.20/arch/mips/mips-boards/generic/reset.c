...
#if defined(CONFIG_MSTAR_TITANIA3) | defined(CONFIG_MSTAR_TITANIA8) | defined(CONFIG_MSTAR_AMBER1) | defined(CONFIG_MSTAR_EMERALD)
...
#elif defined(CONFIG_MSTAR_TITANIA3) | defined(CONFIG_MSTAR_TITANIA8) | defined(CONFIG_MSTAR_AMBER1) | defined(CONFIG_MSTAR_EMERALD)
