...
#if (defined(CONFIG_MSTAR_TITANIA13) || defined(CONFIG_MSTAR_AMBER1) || defined(CONFIG_MSTAR_EMERALD))
...
*/
    ...
    *(volatile uint32*)(0xbf200000+(0x0F53*4)) &= (uint32)(~0xFFFF);          // Clear UART_SEL0
...
#define UART_LCR_DLAB		        0x80	                            // Divisor latch access bit
    ...
    UART_REG8(UART_LCR) &= (unsigned int)(~(UART_LCR_DLAB));					//Line Control Register
