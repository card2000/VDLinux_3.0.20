...
static struct irq_chip amber3_irq_chip = {
	...
	.irq_ack = amber3_irq_ack,
	.irq_mask = amber3_irq_mask,
	.irq_unmask = amber3_irq_unmask,
};

void __iomem *_gic_cpu_base_addr=(0xFC000000 + 0x0100);
void __iomem *_gic_dist_base_addr=(0xFC000000 + 0x1000);
