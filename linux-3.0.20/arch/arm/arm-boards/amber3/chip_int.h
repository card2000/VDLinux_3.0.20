...
//  E_IRQ_RESERVED                              = E_IRQH_START + 8, 
    E_IRQ_VP6                   = E_IRQH_START  + 9,  
...
//  E_FIQEXPL_RESERVED                          = E_FIQEXPL_START + 5,
...
//  E_FIQEXPL_RESERVED                          = E_FIQEXPL_START + 14,
    E_FIQEXPL_GPIO2                     = E_FIQEXPL_START+15,
    E_FIQEXPL_END                       = 15 + E_FIQEXPL_START ,

    E_FIQEXPH_START                     = 16 + E_FIQEXPL_START,
//  E_FIQEXPL_RESERVED                          = E_FIQEXPH_START + 0,
//  E_FIQEXPL_RESERVED                          = E_FIQEXPH_START + 1,
//  E_FIQEXPL_RESERVED                          = E_FIQEXPH_START + 2,
