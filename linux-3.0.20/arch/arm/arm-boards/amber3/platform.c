...
#include "chip_int.h"
	...
	defined(CONFIG_MSTAR_AMBER3) || defined(CONFIG_MSTAR_AMBER5)
...
{
	*((u16 volatile*)(0xFD200DE0)) = *((u16 volatile*)(0xFD200DE0)) | (u16)0xE00;
	printk("#_# %s 0xFD200DE0 => %x\n", __FUNCTION__, *((u16 volatile*)(0xFD200DE0)));
