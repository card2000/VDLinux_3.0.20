...
#define EDISON_IRQ_PMU0 59
#define EDISON_IRQ_PMU1 60
...
typedef enum
{
    ...
    E_IRQ_ERROR_RESP            = E_IRQL_START + 13,
...
//  E_FIQEXPL_RESERVED                          = E_FIQEXPL_START + 3,
    ...
    E_FIQEXPL_ARM_TO_ARMC1      = E_FIQEXPL_START + 9,
    ...
    #define FIQ_CMDQ                            (0x1 << (E_FIQ_CMDQ             - E_FIQH_START) )
    ...
    #define IRQ_AU_DMA                          (0x1 << (E_IRQ_AU_DMA           - E_IRQL_START) )
    ...
    #define IRQ_ERROR_RESP                      (0x1 << (E_IRQ_ERROR_RESP       - E_IRQL_START) )
    ...
    #define IRQ_CBUS_PM                         (0x1 << (E_IRQ_CBUS_PM          - E_IRQH_START) )
