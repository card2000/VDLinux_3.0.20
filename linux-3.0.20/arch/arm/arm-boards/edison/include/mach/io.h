...
#define WDT_STATUS		(0x62c + PT_BASE)
#define WDT_CONTROL		(0x628 + PT_BASE)
#define WDT_COUNTER		(0x624 + PT_BASE)
#define WDT_LOADER		(0x620 + PT_BASE)
...
/* Constants of EDISON L2 Linefill & Prefetch */
