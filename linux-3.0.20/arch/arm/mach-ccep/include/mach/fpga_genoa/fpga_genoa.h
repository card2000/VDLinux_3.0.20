/*
 *  arch/arm/mach-ccep/include/mach/fpga_genoa.h
 *
...
#ifndef __FPGA_GENOA_H
#define __FPGA_GENOA_H
...
#define SDP_GET_TIMERCLK(x)	sdp1001fpga_get_clock(x)
...
#define SDP_GET_UARTCLK(x)		sdp1001fpga_get_clock(x)
...
{{0,    IRQ_TSD,      	LEVEL_LEVEL, POLARITY_HIGH, 0xFFFFFFFF, 0xFFFFFFFF}, \
 ...
 {29,   IRQ_CORTEX_M0,	LEVEL_EDGE_EXT,  POLARITY_HIGH, 0xE0000000, 0xFFFFFFFF}, \
 {30,   IRQ_SUB,     	LEVEL_EDGE_EXT,  POLARITY_HIGH, 0xC0000000, 0xFFFFFFFF}, \
