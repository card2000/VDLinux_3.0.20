...
#define O_PMU_CPU_PMS_CON		(0x0)/* PLL0 PMS */
#define O_PMU_BUS_PMS_CON		(0x4)/* PLL1 PMS */
#define O_PMU_DDR_PMS_CON		(0x20)/* PLL8 PMS */
#define O_PMU_DDR_K_CON			(0x40)/* PLL8 K */
#define O_PMU_DDR_CTRL_CON		(0x64)/* PLL8 CTRL */
...
#define R_PMU_DDR_CTRL_CON	VA_PMU(O_PMU_DDR_CTRL_CON)

#define PMU_PLL_P_VALUE(x)	((x >> 21) & 0xF)
