...
#ifndef _SDP1207_FPGA_IRQS_H_
#define _SDP1207_FPGA_IRQS_H_
...
#define IRQ_RTC			IRQ_SPI(56)
#define IRQ_UDMA_RX		IRQ_SPI(57)
#define IRQ_UDMA_TX		IRQ_SPI(58)
#define IRQ_SSP2		IRQ_SPI(59)
...
#endif /* #define _SDP1207_FPGA_IRQS_H_ */
