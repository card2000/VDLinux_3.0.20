/*
 *  arch/arm/mach-ccep/include/mach/fpga_victoria.h
 *
...
#ifndef __FPGA_VICTORIA_H
#define __FPGA_VICTORIA_H
...
#define SDP_GET_TIMERCLK(x)	sdp1105fpga_get_clock(x)
...
#define SDP_GET_UARTCLK(x)		sdp1105fpga_get_clock(x)
