/*
 *  arch/arm/mach-ccep/include/mach/fpga-foxap.h
 *
...
#ifndef __FPGA_FOXAP_H
#define __FPGA_FOXAP_H
...
#define SDP_GET_TIMERCLK(x)	sdp1202fpga_get_clock(x)
...
#define SDP_GET_UARTCLK(x)		sdp1202fpga_get_clock(x)

#if 0//ndef CONFIG_ARM_GIC
...
{{0,    IRQ_TSD,      	LEVEL_LEVEL, POLARITY_HIGH, 0xFFFFFFFF, 0xFFFFFFFF}, \
 ...
 {26,   IRQ_DSP,  	LEVEL_LEVEL,  POLARITY_HIGH, 0xFC000000, 0xFFFFFFFF}, \
