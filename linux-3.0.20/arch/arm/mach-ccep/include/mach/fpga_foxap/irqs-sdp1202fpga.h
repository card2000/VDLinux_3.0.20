...
#ifndef _SDP1202_FPGA_IRQS_H_
#define _SDP1202_FPGA_IRQS_H_

#define MAX_GIC_NR	1

#define GIC_PPI(x)	((x) + 16)
#define IRQ_LOCALTIMER	GIC_PPI(13)		//irq 29 : non-secure timer(ES0), secure timer(ES1)
//#define IRQ_LOCALTIMER	GIC_PPI(14)		//irq 30 : non-secure timer(ES1), secure timer(ES0)
