/*
 *  arch/arm/mach-ccep/include/mach/griffin.h
 *
...
#define SDP_GET_TIMERCLK(x)	sdp1001_get_clock(x)
...
#define SDP_GET_UARTCLK(x)		sdp1001_get_clock(x)
...
{{0,    IRQ_TSD,      	LEVEL_LEVEL, POLARITY_HIGH, 0xFFFFFFFF, 0xFFFFFFFF}, \
 ...
 {29,   IRQ_CORTEX_M0,	LEVEL_LEVEL_EXT,  POLARITY_HIGH, 0xE0000000, 0xFFFFFFFF}, \
