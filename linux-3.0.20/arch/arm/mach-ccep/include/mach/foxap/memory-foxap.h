/*
 * memory-foxap.h : Define memory address space.
 * 
...
#define SYS_MEM1_SIZE		(0 << 20)
#define SYS_MEM2_SIZE		(0 << 20)

#define MACH_MEM0_SIZE 		SZ_2G
#define MACH_MEM1_SIZE 		SZ_512M
#define MACH_MEM2_SIZE 		SZ_512M
