...
#ifndef __FPGA_SANTOS_H
#define __FPGA_SANTOS_H
...
#define SDP_GET_TIMERCLK(x)	sdp1103fpga_get_clock(x)
...
#define SDP_GET_UARTCLK(x)		sdp1103fpga_get_clock(x)
...
{{0,    IRQ_TSD,      	LEVEL_LEVEL, POLARITY_HIGH, 0xFFFFFFFF, 0xFFFFFFFF}, \
 ...
 {30,   IRQ_MERGER1,   	LEVEL_LEVEL_EXT, POLARITY_LOW,  0xC0000000, 0xFFFFFFFF}, \
 {31,   IRQ_SUB,		LEVEL_LEVEL_EXT, POLARITY_LOW,  0x80000000, 0xFFFFFFFF} }
