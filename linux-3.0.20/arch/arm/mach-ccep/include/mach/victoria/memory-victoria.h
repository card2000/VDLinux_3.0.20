/*
 * memory-victoria.h : Define memory address space.
 * 
 ...
 *
 */
#ifndef _MEMORY_VICTORIA_H_
#define _MEMORY_VICTORIA_H_
...
/* Victoria DDR Bank
 * bank 0:  0x50000000-0x6FFFFFFF - 512MB
 * bank 1:  0x70000000-0x7FFFFFFF - 256MB
 * bank 2:  0x80000000-0x8FFFFFFF - 256MB
 * bank 3:  0x90000000-0xAFFFFFFF - 512MB
 */
...
#define __phys_to_virt(x) \
	({ u32 val = PAGE_OFFSET; \
       switch((x - MACH_MEM0_BASE) >> MACH_MEM_SHIFT) { \
	   	case 5:         \
			val += 0x10000000; \
	   	case 4:         \
...
#define PFN_TO_NID(pfn) \
	(((pfn) >> (MACH_MEM_SHIFT - PAGE_SHIFT)) - 5)
...
/* 0x50000000~0x70000000 0x70000000~0x80000000, 0x80000000~0x90000000 0x90000000~0xB0000000*/
