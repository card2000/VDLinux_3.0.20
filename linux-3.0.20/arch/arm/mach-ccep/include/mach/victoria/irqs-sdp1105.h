 ...
 * Seihee Chon <sh.cho@samsung.com>
 *
 */

#ifndef _IRQS_SDP1105_H_
#define _IRQS_SDP1105_H_
...
#define IRQ_MFD         IRQ_SPI(29)                                
#define IRQ_GMAC        IRQ_SPI(30)                                
#define IRQ_SDMMC       IRQ_SPI(31)                                
#define IRQ_GDMA0       IRQ_SPI(32)                                
#define IRQ_GDMA1       IRQ_SPI(33)                                
...
#define IRQ_BDGA_RAW11  IRQ_SPI(64)
#define IRQ_BDGA_RAW12  IRQ_SPI(65)
