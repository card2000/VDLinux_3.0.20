...
#define PA_INTC_BASE0         PA_INTC_BASE
#define VA_INTC_BASE0         VA_INTC_BASE

#define PA_INTC_BASE1         (0x30090E00)
#define VA_INTC_BASE1         (PA_INTC_BASE1 + DIFF_IO_BASE0)

/* SD/MMC host controller Register */
#define PA_MMC_BASE           (0x30040C00)
#define VA_MMC_BASE           (PA_MMC_BASE + DIFF_IO_BASE0)

/* Ethernet Controller Register */
#define PA_GMAC_BASE           (0x300A0000)
...
#define PA_XHCI0_BASE         (0xc0000000)
...
/* DMA330 controller register */
#define PA_DMA330_BASE         (0x30B60000)
#define VA_DMA330_BASE         (PA_DMA330_BASE + DIFF_IO_BASE0)
...
#define O_PMU_CPU_PMS_CON		(0x04)
#define O_PMU_DDR_PMS_CON		(0x08)
#define O_PMU_DSP_PMS_CON		(0x0C)
#define O_PMU_DDR_K_CON			(0x20)
...
#define R_PMU_DSP_PMS_CON	VA_PMU(O_PMU_DSP_PMS_CON)
