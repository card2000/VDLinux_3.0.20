...
#ifndef _SDP1106_FPGA_IRQS_H_
#define _SDP1106_FPGA_IRQS_H_
...
#define IRQ_USB_EHCI0	IRQ_SPI(23)
#define IRQ_EMAC		IRQ_SPI(24)
#define IRQ_USB_EHCI1	IRQ_SPI(25)
...
#define IRQ_USB_OHCI0	IRQ_SPI(32)
#define IRQ_USB_OHCI1	IRQ_SPI(33)
...
#define IRQ_USB0_VBUSVALID	IRQ_SPI(62)
#define IRQ_USB1_VBUSVALID 	IRQ_SPI(63)
...
#define IRQ_MMCIF      		27
#define IRQ_OSDP      		28
#define IRQ_MERGER0 		29	/* IRR, RTC, IRB, SPI, SMCDMA, AMSDMA */
#define IRQ_MERGER1			30	/* EXT0 ~ 7 */
#define IRQ_SUB   			31	/* USB0_VBUSVALID, USB1_VBUSVALID */
