/*
 *  arch/arm/mach-ccep/include/mach/fpga-flamengo.h
 *
...
#ifndef __FPGA_FLAMENGO_H
#define __FPGA_FLAMENGO_H
...
#define SDP_GET_TIMERCLK(x)	sdp1106fpga_get_clock(x)
...
#define SDP_GET_UARTCLK(x)		sdp1106fpga_get_clock(x)
