...
static int sdp1114_gmac_init(void)
{
	/* SRAM select*/
...
static struct sdp_gmac_plat sdp_gmac_platdata =  {
	.init = sdp1114_gmac_init,/* board specipic init */
...
static int sdp1114_mmch_init(SDP_MMCH_T *p_sdp_mmch)
{
...
static int __init sdp1114_spi_init(void)
{
	int tmp;
