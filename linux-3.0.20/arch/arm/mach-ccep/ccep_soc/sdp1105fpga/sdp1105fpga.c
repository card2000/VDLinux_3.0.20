...
static struct map_desc sdp1105fpga_io_desc[] __initdata = {
/* ------------------------------------------- */
...
static struct platform_device* sdp1105fpga_init_devs[] __initdata = {
	&sdp_uart0,
	&sdp_sata0, 
	&sdp_sata1,
...
void __init sdp1105fpga_iomap_init (void)
{
	iotable_init(sdp1105fpga_io_desc, ARRAY_SIZE(sdp1105fpga_io_desc));
}

static int sdp1105fpga_get_revision_id(void)
{
#if 0	
...
static void __init sdp1105fpga_l2c_init(void)
{
...
void __init sdp1105fpga_init(void)
{
	sdp1105fpga_get_revision_id();
	sdp1105fpga_l2c_init();
	platform_add_devices(sdp1105fpga_init_devs, ARRAY_SIZE(sdp1105fpga_init_devs));
}
