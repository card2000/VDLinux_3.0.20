...
static struct map_desc sdp1103fpga_io_desc[] __initdata = {
/* ------------------------------------------- */
...
static struct platform_device* sdp1103fpga_init_devs[] __initdata = {
	&sdp_uart0,
/*
	&sdp_uart1,
	&sdp_uart2,
...
void __init sdp1103fpga_iomap_init (void)
{
	iotable_init(sdp1103fpga_io_desc, ARRAY_SIZE(sdp1103fpga_io_desc));
}
...
static void __init sdp1103fpga_l2c_init(void)
{
...
void __init sdp1103fpga_init(void)
{
	sdp1103_get_revision_id();
	sdp1103fpga_l2c_init();
	platform_add_devices(sdp1103fpga_init_devs, ARRAY_SIZE(sdp1103fpga_init_devs));
}
