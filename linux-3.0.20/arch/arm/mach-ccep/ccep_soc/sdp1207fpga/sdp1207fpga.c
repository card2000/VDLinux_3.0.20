...
static struct map_desc sdp1207fpga_io_desc[] __initdata = {
/* ------------------------------------------- */
...
static struct platform_device* sdp1207fpga_init_devs[] __initdata = {
...
void __init sdp1207fpga_iomap_init (void)
{
	iotable_init(sdp1207fpga_io_desc, ARRAY_SIZE(sdp1207fpga_io_desc));
}

static int sdp1207fpga_get_revision_id(void)
{
#if 0	
...
static void __init sdp1207fpga_l2c_init(void)
{
...
#else	/* CONFIG_SDP1207_L2C310 */
static void __init sdp1207fpga_l2c_init(void) {}
#endif

void __init sdp1207fpga_init(void)
{
	sdp1207fpga_get_revision_id();
	sdp1207fpga_l2c_init();
	platform_add_devices(sdp1207fpga_init_devs, ARRAY_SIZE(sdp1207fpga_init_devs));
}
