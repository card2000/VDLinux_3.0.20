...
static struct map_desc sdp1103_io_desc[] __initdata = {
/* ------------------------------------------- */
...
static struct platform_device* sdp1103_init_devs[] __initdata = {
	&sdp_uart0,
	&sdp_uart1,
	&sdp_uart2,
	&sdp_uart3,
...
void __init sdp1103_iomap_init (void)
{
	iotable_init(sdp1103_io_desc, ARRAY_SIZE(sdp1103_io_desc));
}

static int sdp1103_get_revision_id(void)
{
#if 0
...
static void __init sdp1103_l2c_init(void)
{
	...
	l2x0_init (base, L2C310_AUX_BRESP | L2C310_AUX_IPF | L2C310_AUX_DPF, ~(L2C310_AUX_RR));
}
#else	/* CONFIG_SDP1103_L2C310 */
static void __init sdp1103_l2c_init(void) {}
#endif

void __init sdp1103_init(void)
{
	int i;
	sdp1103_get_revision_id();
	platform_add_devices(sdp1103_init_devs, ARRAY_SIZE(sdp1103_init_devs));
