...
static struct map_desc sdp1106fpga_io_desc[] __initdata = {
/* ------------------------------------------- */
...
static struct platform_device* sdp1106fpga_init_devs[] __initdata = {
	&sdp_uart0,
/*	&sdp_uart1,
	&sdp_uart2,
	&sdp_uart3,
...
void __init sdp1106fpga_iomap_init (void)
{
	iotable_init(sdp1106fpga_io_desc, ARRAY_SIZE(sdp1106fpga_io_desc));
}

static int sdp1106fpga_get_revision_id(void)
{
#if 0	
...
static void __init sdp1106fpga_l2c_init(void)
{
...
void __init sdp1106fpga_init(void)
{
	sdp1106fpga_get_revision_id();
	sdp1106fpga_l2c_init();
	platform_add_devices(sdp1106fpga_init_devs, ARRAY_SIZE(sdp1106fpga_init_devs));
}
