...
static struct map_desc sdp1002_io_desc[] __initdata = {
/* ------------------------------------------- */
...
static struct platform_device* sdp1002_init_devs[] __initdata = {
	&sdp_uart0,
	&sdp_uart1,
	&sdp_uart2,
	&sdp_uart3,
...
void __init sdp1002_iomap_init (void)
{
	iotable_init(sdp1002_io_desc, ARRAY_SIZE(sdp1002_io_desc));
}

static int sdp1002_get_revision_id(void)
{
...
void __init sdp1002_init(void)
{
	sdp1002_get_revision_id();
	platform_add_devices(sdp1002_init_devs, ARRAY_SIZE(sdp1002_init_devs));
}
