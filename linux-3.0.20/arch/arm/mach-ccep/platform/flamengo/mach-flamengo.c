...
extern void sdp1106_init(void);
extern void sdp1106_iomap_init(void);
...
static void __init flamengo_init(void)
{
	sdp1106_init();
}

static void __init 
flamengo_fixup(struct machine_desc *desc, struct tag *tags, char ** cmdline, struct meminfo *meminfo)
{
	int nbank = 0;
...
MACHINE_START(SDP1106_FLAMENGO, "Samsung SDP1106 evaluation board")
...
#endif
	.timer		= &sdp_timer,
	.init_machine	= flamengo_init,
	.fixup		= flamengo_fixup,
MACHINE_END
