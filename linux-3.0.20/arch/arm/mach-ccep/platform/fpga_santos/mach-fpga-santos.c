...
extern void sdp1103fpga_init(void);
extern void sdp1103fpga_iomap_init(void);
...
#if 0
static struct map_desc fpga_santos_io_desc[] __initdata = {
{ 
...
static void __init fpga_santos_iomap_init(void)
{
//	iotable_init(fpga_santos_io_desc, ARRAY_SIZE(fpga_santos_io_desc));
}
#endif
...
static void __init fpga_santos_init(void)
{
	sdp1103fpga_init();
}

static void __init 
fpga_santos_fixup(struct machine_desc *mdesc, struct tag *tags, char ** cmdline, struct meminfo *meminfo)
{
	int nbank = 0;
...
MACHINE_START(SDP1103FPGA_SANTOS, "Samsung SDP1103 FPGA board")
	.phys_io  = PA_IO_BASE0,
	.io_pg_offst = VA_IO_BASE0,
	.boot_params  = (PHYS_OFFSET + 0x100),
	.map_io		= fpga_santos_map_io,
	.init_irq	= sdp_init_irq,
	.timer		= &sdp_timer,
	.init_machine	= fpga_santos_init,
	.fixup		= fpga_santos_fixup,
MACHINE_END
