...
# define N_I2C_PORT	5
# define O_I2C_PEND	0xE0
# define I2C_SDA_SKEW	7  	//  1.221 '1' -> '7'
#else
...
// 1.22, 0x20 -> 0x18
#define STATUS_TRY_READY		0x18    // use this at check_bus Dec,24,2008 // 1.22

// 1.22
#define STATUS_EDID			(0x20)
#define STATUS_EDID_READ		(STATUS_EDID)		// 1.22, Nack is default
// 1.22, if segment is not '0', ack op
#define STATUS_EDID_SEG_ACK		(STATUS_EDID | 1)	
#define STATUS_EDID_SEG_NACK		(STATUS_EDID | 2)	
...
#define STATUS_EDID_READ_ERR		0xC1	// "1.22"
