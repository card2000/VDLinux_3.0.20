...
extern UINT32 NC_Init (PureNANDSpec *pstPNDSpec);
extern UINT32 MSTAR_NAND_INIT(void);
extern UINT8 *NC_ReadID(void);

extern UINT32 NC_ReadPages (PureNANDSpec     *pstPNDSpec, UINT32 u32_PhyRowIdx, UINT8 *pu8_DataBuf, UINT8 *pu8_SpareBuf, UINT32 u32_PageCnt);
extern UINT32 NC_EraseBlk(PureNANDSpec     *pstPNDSpec, UINT32 u32_PhyRowIdx);
extern UINT32 NC_WritePages(PureNANDSpec     *pstPNDSpec, UINT32 u32_PhyRowIdx, UINT8 *pu8_DataBuf, UINT8 *pu8_SpareBuf, UINT32 u32_PageCnt);
extern UINT32 NC_Read_RandomIn (PureNANDSpec     *pstPNDSpec, UINT32 u32_PhyRow, UINT32 u32Col, UINT8 *pu8DataBuf, UINT32 u32DataByteCnt);
extern UINT32 NC_Write_RandomOut(PureNANDSpec *pstPNDSpec, UINT32 u32_PhyRow, UINT32 u32_Col, UINT8 *pu8_DataBuf, UINT32 u32_DataByteCnt);
extern VOID  NC_ControlECC(BOOL32 ecc_on);
extern void NC_DisableECC(void);
extern void NC_EnableECC(void);
extern void print_ECC_Reg(void);
extern void NC_Dump_Registers(void);
