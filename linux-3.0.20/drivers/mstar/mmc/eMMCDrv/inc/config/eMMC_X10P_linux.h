...
#ifndef __eMMC_X10P_LINUX__
#define __eMMC_X10P_LINUX__
...
#define eMMC_FCIE_VALID_CLK_CNT             11 // FIXME
...
#define reg_chiptop_0x10                    GET_REG_ADDR(PAD_CHIPTOP_BASE, 0x10)    // U02
#define reg_chiptop_0x1C                    GET_REG_ADDR(PAD_CHIPTOP_BASE, 0x1C)    // U02
...
#define IF_FCIE_SHARE_PINS                  1 // 1: need to eMMC_pads_switch
...
#define FCIE_DEFAULT_CLK                    BIT_FCIE_CLK_32M
