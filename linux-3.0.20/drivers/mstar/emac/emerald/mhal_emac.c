...
struct _MHalUtilityVarsEMAC
{
    ...
    u8 flagISR_INT_DONE;
    char padding [3]; //padding for alignment boundary
};
...
void MHal_EMAC_write_phy( unsigned char phy_addr, unsigned char address, u32 value )
{
    ...
    *(volatile unsigned int *)(uRegBase + (u32)(address*4)) = (unsigned int)value;
    udelay( 1 );
#else
...
void MHal_EMAC_read_phy( unsigned char phy_addr, unsigned char address, u32* value )
{
    ...
    tempvalue |= 0x0004;
    *(volatile unsigned int *)(INTERNEL_PHY_REG_BASE + (u32)0x04) = (unsigned int)tempvalue;
    udelay( 1 );
    *value = *(volatile unsigned int *)(uRegBase + (u32)(address*4)); 
#else
    u32 uRegVal = 0, uCTL = 0;
...
void MHal_EMAC_TX_10MB_lookUp_table( void )
{
    ...
    *( ( u32 * ) ( ( u32 ) INTERNEL_PHY_REG_BASE +  0x0f*4) ) = 0x9800;
    *( ( u32 * ) ( ( u32 ) INTERNEL_PHY_REG_BASE +  0x10*4) ) = 0x8484;
    *( ( u32 * ) ( ( u32 ) INTERNEL_PHY_REG_BASE +  0x11*4) ) = 0x8888;
    *( ( u32 * ) ( ( u32 ) INTERNEL_PHY_REG_BASE +  0x12*4) ) = 0x8c8c;
    *( ( u32 * ) ( ( u32 ) INTERNEL_PHY_REG_BASE +  0x13*4) ) = 0xC898;
    *( ( u32 * ) ( ( u32 ) INTERNEL_PHY_REG_BASE +  0x14*4) ) = 0x0000;
    *( ( u32 * ) ( ( u32 ) INTERNEL_PHY_REG_BASE +  0x15*4) ) = 0x1000;
    *( ( u32 * ) ( ( u32 ) INTERNEL_PHY_REG_BASE +  0x16*4) ) = ( (*( ( u32 * ) ( ( u32 ) INTERNEL_PHY_REG_BASE +  0x16*4) ) & 0xFF00) | 0x0000 );    

    // tx 10T look up table.
    *( ( u32 * ) ( ( u32 ) INTERNEL_PHY_REG_BASE +  0x44*4) ) = 0x3C3C;
    *( ( u32 * ) ( ( u32 ) INTERNEL_PHY_REG_BASE +  0x45*4) ) = 0x3C3C;
    *( ( u32 * ) ( ( u32 ) INTERNEL_PHY_REG_BASE +  0x46*4) ) = 0x3C30;
    *( ( u32 * ) ( ( u32 ) INTERNEL_PHY_REG_BASE +  0x47*4) ) = 0x687C;
    *( ( u32 * ) ( ( u32 ) INTERNEL_PHY_REG_BASE +  0x48*4) ) = 0x7834;
    *( ( u32 * ) ( ( u32 ) INTERNEL_PHY_REG_BASE +  0x49*4) ) = 0xD494;
    *( ( u32 * ) ( ( u32 ) INTERNEL_PHY_REG_BASE +  0x4A*4) ) = 0x84A0;
    *( ( u32 * ) ( ( u32 ) INTERNEL_PHY_REG_BASE +  0x4B*4) ) = 0xE4C8;
    *( ( u32 * ) ( ( u32 ) INTERNEL_PHY_REG_BASE +  0x4C*4) ) = 0xC8C8;
    *( ( u32 * ) ( ( u32 ) INTERNEL_PHY_REG_BASE +  0x4D*4) ) = 0xC8E8;
    *( ( u32 * ) ( ( u32 ) INTERNEL_PHY_REG_BASE +  0x4E*4) ) = 0x3C3C;
    *( ( u32 * ) ( ( u32 ) INTERNEL_PHY_REG_BASE +  0x4F*4) ) = 0x3C3C;
    *( ( u32 * ) ( ( u32 ) INTERNEL_PHY_REG_BASE +  0x50*4) ) = 0x2430;
    *( ( u32 * ) ( ( u32 ) INTERNEL_PHY_REG_BASE +  0x51*4) ) = 0x707C;    
    *( ( u32 * ) ( ( u32 ) INTERNEL_PHY_REG_BASE +  0x52*4) ) = 0x6420;
    *( ( u32 * ) ( ( u32 ) INTERNEL_PHY_REG_BASE +  0x53*4) ) = 0xD4A0;
    *( ( u32 * ) ( ( u32 ) INTERNEL_PHY_REG_BASE +  0x54*4) ) = 0x8498;
    *( ( u32 * ) ( ( u32 ) INTERNEL_PHY_REG_BASE +  0x55*4) ) = 0xD0C8;
    *( ( u32 * ) ( ( u32 ) INTERNEL_PHY_REG_BASE +  0x56*4) ) = 0xC8C8;
    *( ( u32 * ) ( ( u32 ) INTERNEL_PHY_REG_BASE +  0x57*4) ) = 0xC8C8; 
}
#endif
...
void MHal_EMAC_update_speed_duplex( u32 uspeed, u32 uduplex )
{
    ...
    xval = MHal_EMAC_ReadReg32( REG_ETH_CFG ) & ~( (u32)(EMAC_SPD | EMAC_FD) );
...
{
    u8 hashIdx0 = (u8)(( m0&0x01 ) ^ ( ( m0&0x40 ) >> 6 ) ^ ( ( m1&0x10 ) >> 4 ) ^ ( ( m2&0x04 ) >> 2 )
                 ^ ( m3&0x01 ) ^ ( ( m3&0x40 ) >> 6 ) ^ ( ( m4&0x10 ) >> 4 ) ^ ( ( m5&0x04 ) >> 2 ));

     u8 hashIdx1 = (u8)(( m0&0x02 ) ^ ( ( m0&0x80 ) >> 6 ) ^ ( ( m1&0x20 ) >> 4 ) ^ ( ( m2&0x08 ) >> 2 )
                ^ ( m3&0x02 ) ^ ( ( m3&0x80 ) >> 6 ) ^ ( ( m4&0x20 ) >> 4 ) ^ ( ( m5&0x08 ) >> 2 ));

    u8 hashIdx2 = (u8)(( m0&0x04 ) ^ ( ( m1&0x01 ) << 2 ) ^ ( ( m1&0x40 ) >> 4 ) ^ ( ( m2&0x10 ) >> 2 )
                ^ ( m3&0x04 ) ^ ( ( m4&0x01 ) << 2 ) ^ ( ( m4&0x40 ) >> 4 ) ^ ( ( m5&0x10 ) >> 2 ));

    u8 hashIdx3 = (u8)(( m0&0x08 ) ^ ( ( m1&0x02 ) << 2 ) ^ ( ( m1&0x80 ) >> 4 ) ^ ( ( m2&0x20 ) >> 2 )
                ^ ( m3&0x08 ) ^ ( ( m4&0x02 ) << 2 ) ^ ( ( m4&0x80 ) >> 4 ) ^ ( ( m5&0x20 ) >> 2 ));

    u8 hashIdx4 = (u8)(( m0&0x10 ) ^ ( ( m1&0x04 ) << 2 ) ^ ( ( m2&0x01 ) << 4 ) ^ ( ( m2&0x40 ) >> 2 )
                ^ ( m3&0x10 ) ^ ( ( m4&0x04 ) << 2 ) ^ ( ( m5&0x01 ) << 4 ) ^ ( ( m5&0x40 ) >> 2 ));

    u8 hashIdx5 = (u8)(( m0&0x20 ) ^ ( ( m1&0x08 ) << 2 ) ^ ( ( m2&0x02 ) << 4 ) ^ ( ( m2&0x80 ) >> 2 )
...
void MHal_EMAC_Power_On_Clk( void )
{
    ...
    *( ( u32 * ) ( ( u32 ) 0xBF243200 +  0x6F*4) ) = ( (*( ( u32 * ) ( ( u32 ) 0xBF243200 +  0x6F*4) ) & 0xFF00) | 0x0059 );
    *( ( u32 * ) ( ( u32 ) 0xBF243200 +  0x7A*4) ) = ( (*( ( u32 * ) ( ( u32 ) 0xBF243200 +  0x7A*4) ) & 0xFF00) | 0x0021 );
    *( ( u32 * ) ( ( u32 ) 0xBF243200 +  0x5B*4) ) = ( (*( ( u32 * ) ( ( u32 ) 0xBF243200 +  0x5B*4) ) & 0x00FF) | 0x0700 );
    *( ( u32 * ) ( ( u32 ) 0xBF243200 +  0x65*4) ) = ( (*( ( u32 * ) ( ( u32 ) 0xBF243200 +  0x65*4) ) & 0x00FF) | 0x1100 );
    *( ( u32 * ) ( ( u32 ) 0xBF243200 +  0x66*4) ) = ( (*( ( u32 * ) ( ( u32 ) 0xBF243200 +  0x66*4) ) & 0xFF00) | 0x0080 );
    *( ( u32 * ) ( ( u32 ) 0xBF243200 +  0x66*4) ) = ( (*( ( u32 * ) ( ( u32 ) 0xBF243200 +  0x66*4) ) & 0x00FF) | 0xd100 );
    *( ( u32 * ) ( ( u32 ) 0xBF243200 +  0x6A*4) ) = (*( ( u32 * ) ( ( u32 ) 0xBF243200 +  0x6A*4) ) & 0xFF00);
    *( ( u32 * ) ( ( u32 ) 0xBF243200 +  0x5C*4) ) = ( (*( ( u32 * ) ( ( u32 ) 0xBF243200 +  0x5C*4) ) & 0x00FF) | 0x4000 );
    *( ( u32 * ) ( ( u32 ) 0xBF243200 +  0x5D*4) ) = ( (*( ( u32 * ) ( ( u32 ) 0xBF243200 +  0x5D*4) ) & 0x00FF) | 0x0500 );
    *( ( u32 * ) ( ( u32 ) 0xBF243200 +  0x58*4) ) = 0x6002;
    //*( ( u32 * ) ( ( u32 ) 0xBF243000 +  0x16*4) ) = ( (*( ( u32 * ) ( ( u32 ) 0xBF243000 +  0x16*4) ) & 0x00FF) | 0x1C00 );
    *( ( u32 * ) ( ( u32 ) 0xBF243000 +  0x39*4) ) = ( (*( ( u32 * ) ( ( u32 ) 0xBF243000 +  0x39*4) ) & 0xFFF7)); //unset loop_back_enable
    *( ( u32 * ) ( ( u32 ) 0xBF243200 +  0x5A*4) ) = ( (*( ( u32 * ) ( ( u32 ) 0xBF243200 +  0x5A*4) ) & 0xFF00) | 0x0056 ); //gain shift
    *( ( u32 * ) ( ( u32 ) 0xBF243200 +  0x27*4) ) = ( (*( ( u32 * ) ( ( u32 ) 0xBF243200 +  0x27*4) ) & 0x00FF) | 0x0200 ); //det max
    *( ( u32 * ) ( ( u32 ) 0xBF243200 +  0x28*4) ) = ( (*( ( u32 * ) ( ( u32 ) 0xBF243200 +  0x28*4) ) & 0x00FF) | 0x0100 ); //det min

    // Set MII Mode
    *( ( u32 * ) ( ( u32 ) 0xBF201600 +  0x60*4) ) = 0x0000;
    *( ( u32 * ) ( ( u32 ) 0xBF201600 +  0x61*4) ) = 0x0000;
    *( ( u32 * ) ( ( u32 ) 0xBF201600 +  0x62*4) ) = 0x0001;
#else
    *( ( u32 * ) ( ( u32 ) 0xBF201600 +  0x60*4) ) = 0x0400;
    *( ( u32 * ) ( ( u32 ) 0xBF201600 +  0x61*4) ) = 0x0004;
    *( ( u32 * ) ( ( u32 ) 0xBF201600 +  0x62*4) ) = 0x0000;
#endif

    //chiptop [15] allpad_in
    *( ( u32 * ) ( ( u32 ) 0xBF203C00 + 0x50*4 ) ) &= 0x7FFF;
#ifdef CONFIG_ETHERNET_ALBANY
    //chiptop pad_top [9:8]
    *( ( u32 * ) ( ( u32 ) 0xBF203C00 + 0x6F*4 ) ) &= (u32)(~0x0100);
#else
    *( ( u32 * ) ( ( u32 ) 0xBF203C00 + 0x6F*4 ) ) |= 0x0100;  //et_mode = 1
#endif
...
{
    //emac_clk gen
    //*( ( u32 * ) ( ( u32 ) 0xBF201600 +  0x60*4) ) = 0x0101;
    //*( ( u32 * ) ( ( u32 ) 0xBF201600 +  0x61*4) ) = 0x0101;
#ifdef CONFIG_ETHERNET_ALBANY
    *( ( u32 * ) ( ( u32 ) 0xBF243000 +  0x00*4) ) = (*( ( u32 * ) ( ( u32 ) 0xBF243000 +  0x00*4) ) | 0x8000);
    udelay( 20 );
    *( ( u32 * ) ( ( u32 ) 0xBF243200 +  0x5B*4) ) = ( (*( ( u32 * ) ( ( u32 ) 0xBF243200 +  0x5B*4) ) & 0x00FF) | 0x1700 );
    *( ( u32 * ) ( ( u32 ) 0xBF243200 +  0x65*4) ) = ( (*( ( u32 * ) ( ( u32 ) 0xBF243200 +  0x65*4) ) & 0x00FF) | 0x0300 );
    *( ( u32 * ) ( ( u32 ) 0xBF243200 +  0x66*4) ) = ( (*( ( u32 * ) ( ( u32 ) 0xBF243200 +  0x66*4) ) & 0xFF00) | 0x0090 );
    *( ( u32 * ) ( ( u32 ) 0xBF243200 +  0x66*4) ) = ( (*( ( u32 * ) ( ( u32 ) 0xBF243200 +  0x66*4) ) & 0x00FF) | 0xd900 );
    *( ( u32 * ) ( ( u32 ) 0xBF243200 +  0x6A*4) ) = ( (*( ( u32 * ) ( ( u32 ) 0xBF243200 +  0x6A*4) ) & 0xFF00) | 0x0020 );
    *( ( u32 * ) ( ( u32 ) 0xBF243200 +  0x5C*4) ) = ( (*( ( u32 * ) ( ( u32 ) 0xBF243200 +  0x5C*4) ) & 0x00FF) | 0x4100 );
    *( ( u32 * ) ( ( u32 ) 0xBF243200 +  0x5D*4) ) = ( (*( ( u32 * ) ( ( u32 ) 0xBF243200 +  0x5D*4) ) & 0x00FF) | 0xC500 );
    *( ( u32 * ) ( ( u32 ) 0xBF243200 +  0x58*4) ) = 0x7003;
    *( ( u32 * ) ( ( u32 ) 0xBF243000 +  0x00*4) ) = (*( ( u32 * ) ( ( u32 ) 0xBF243000 +  0x00*4) ) & 0x7FFF);
#endif
}
