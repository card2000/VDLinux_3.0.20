...
void MHal_EMAC_phy_amp(u16 offset)
{
    u32 uRegVal1;
	u32 uRegVal2;
	u16 idx;
	...
	*( ( u32 * ) ( ( char * ) 0xFD245200 +  0x60*4) )= ((*( ( u32 * ) ( ( char * ) 0xFD245200 +  0x60*4) )& 0xFC1F) | uRegVal2 << 5);
	uRegVal1 = (*( ( u32 * ) ( ( char * ) 0xFD004000 +  0x0A*4) )) & 0x003E ;
	*( ( u32 * ) ( ( char * ) 0xFD245200 +  0x60*4) )= ((*( ( u32 * ) ( ( char * ) 0xFD245200 +  0x60*4) )& 0x83FF) | uRegVal1 << 9);
    *( ( u32 * ) ( ( char * ) 0xFD245000 +  0x2E*4) )= ((*( ( u32 * ) ( ( char * ) 0xFD245000 +  0x2E*4) )& 0xFFFE) | 0x0001);
