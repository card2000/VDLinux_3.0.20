...
u8 MY_MAC[6] = { 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF };
...
struct _UtilityVarsEMAC
{
    ...
    u8 flagRBNA;
    char padding[1]; //padding for alignment boundary
    // Misc Counter:
