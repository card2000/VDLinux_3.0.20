...
void MHal_EMAC_phy_amp(s16 offset)
{
    u32 uRegVal1;
	u32 uRegVal2;
	s16 idx;
	u8  table[32]={0x1F,0x1E,0x1D,0x1C,0x1B,0x1A,0x19,0x18,
		           0x17,0x16,0x15,0x14,0x13,0x12,0x11,0x10,
		           0x00,0x01,0x02,0x03,0x04,0x05,0x06,0x07,
		           0x08,0x09,0x0A,0x0B,0x0C,0x0D,0x0E,0x0F};
	
    uRegVal1 = *( ( u32 * ) ( ( char * ) 0xFD004000 +  0x0A*4) );

	uRegVal1 = uRegVal1 & 0x0001;
	uRegVal2 = *( ( u32 * ) ( ( char * ) 0xFD004000 +  0x09*4) );
	uRegVal2 = uRegVal2 >> 12;
	uRegVal2 = uRegVal2 & 0x000f;
	uRegVal2 = (uRegVal1 << 4) | uRegVal2;

	for(idx = 0; idx<32; idx++)
	{
		if(uRegVal2 == table[idx])
		{
		    break;
		}
	}
	...
	*( ( u32 * ) ( ( u32 ) 0xFD245200 +  0x60*4) )= ((*( ( u32 * ) ( ( u32 ) 0xFD245200 +  0x60*4) )& 0xFC1F) | uRegVal2 << 5);
	uRegVal1 = (*( ( u32 * ) ( ( u32 ) 0xFD004000 +  0x0A*4) )) & 0x003E ;
	*( ( u32 * ) ( ( u32 ) 0xFD245200 +  0x60*4) )= ((*( ( u32 * ) ( ( u32 ) 0xFD245200 +  0x60*4) )& 0x83FF) | uRegVal1 << 9);
    *( ( u32 * ) ( ( u32 ) 0xFD245000 +  0x2E*4) )= ((*( ( u32 * ) ( ( u32 ) 0xFD245000 +  0x2E*4) )& 0xFFFE) | 0x0001);
...
{
    *( ( u32 * ) ( ( char * ) 0xFD204200 +  0x1D*4) ) = 0x0100; //swith RX discriptor format to mode 1
    //emac_clk gen
#ifdef CONFIG_ETHERNET_ALBANY
    MHal_EMAC_TX_10MB_lookUp_table();
    //MHal_EMAC_phy_amp(2);
    *( ( u32 * ) ( ( char * ) 0xFD245200 +  0x6F*4) ) = ( (*( ( u32 * ) ( ( char * ) 0xFD245200 +  0x6F*4) ) & 0xFF00) | 0x0059 );
    *( ( u32 * ) ( ( char * ) 0xFD245200 +  0x7A*4) ) = ( (*( ( u32 * ) ( ( char * ) 0xFD245200 +  0x7A*4) ) & 0xFF00) | 0x0021 );
    *( ( u32 * ) ( ( char * ) 0xFD245000 +  0x39*4) ) = ( (*( ( u32 * ) ( ( char * ) 0xFD245000 +  0x39*4) ) & 0xFF00) | 0x0080 );
    *( ( u32 * ) ( ( char * ) 0xFD245200 +  0x5B*4) ) = ( (*( ( u32 * ) ( ( char * ) 0xFD245200 +  0x5B*4) ) & 0x00FF) | 0x0700 );
    *( ( u32 * ) ( ( char * ) 0xFD245200 +  0x65*4) ) = ( (*( ( u32 * ) ( ( char * ) 0xFD245200 +  0x65*4) ) & 0x00FF) | 0x1100 );
    *( ( u32 * ) ( ( char * ) 0xFD245200 +  0x66*4) ) = 0xD180;
    *( ( u32 * ) ( ( char * ) 0xFD245200 +  0x6A*4) ) = (*( ( u32 * ) ( ( char * ) 0xFD245200 +  0x6A*4) ) & 0xFF00);
    *( ( u32 * ) ( ( char * ) 0xFD245200 +  0x5C*4) ) = ( (*( ( u32 * ) ( ( char * ) 0xFD245200 +  0x5C*4) ) & 0x00FF) | 0x4000 );
    *( ( u32 * ) ( ( char * ) 0xFD245200 +  0x5D*4) ) = ( (*( ( u32 * ) ( ( char * ) 0xFD245200 +  0x5D*4) ) & 0x00FF) | 0x0500 );
    *( ( u32 * ) ( ( char * ) 0xFD245200 +  0x58*4) ) = 0x6002;
    /* resolve  that PHY cannot link when distance over 100M */
    //*( ( u32 * ) ( ( char * ) 0xBF203C00 +  0x5A*4) ) = ( (*( ( u32 * ) ( ( char * ) 0xBF203C00 +  0x5A*4) ) & 0xFF00) | 0x0010 );
    *( ( u32 * ) ( ( char * ) 0xFD245000 +  0x39*4) ) = ( (*( ( u32 * ) ( ( char * ) 0xFD245000 +  0x39*4) ) & 0xFFF7)); //unset loop_back_enable
    *( ( u32 * ) ( ( char * ) 0xFD245200 +  0x5A*4) ) = ( (*( ( u32 * ) ( ( char * ) 0xFD245200 +  0x5A*4) ) & 0xFF00) | 0x0056 ); //gain shift
    ...
    *( ( u32 * ) ( ( char * ) 0xFD245200 +  0x3B*4) ) = ( (*( ( u32 * ) ( ( char * ) 0xFD245200 +  0x3B*4) ) & 0x00FF) | 0x1800); //snr len (emc noise)
    *( ( u32 * ) ( ( char * ) 0xFD245200 +  0x21*4) ) = ( (*( ( u32 * ) ( ( char * ) 0xFD245200 +  0x21*4) ) & 0x00FF) | 0x1500); //snr k value
    /* For pass ESD test */
    *( ( u32 * ) ( ( char * ) 0xFD245000 +  0x62*2) ) = 0x112b;
    *( ( u32 * ) ( ( char * ) 0xFD245000 +  0x60*2) ) = 0x06a4;
    // Set MII Mode
