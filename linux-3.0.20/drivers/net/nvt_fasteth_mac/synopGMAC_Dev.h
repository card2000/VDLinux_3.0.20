...
#define MDC_CLOCK_DIV 			GmiiCsrClk1 // for ahb 48MHz 
								//GmiiCsrClk0		// jay hsu : set our mdc divider for ahb 96M
...
#define TRANSMIT_DESC_SIZE  256 //256	//Tx Descriptors needed in the Descriptor pool/queue
#define RECEIVE_DESC_SIZE   256 //256	//Rx Descriptors needed in the Descriptor pool/queue
...
{                               
  ...
  // jay hsu : add 8 bytes for cache alignment (32 bytes)
  u32 	dummy1;
  u32	dummy2;

	// Jay Hsu @ 20110520 : add 32 dummy bytes for cache alignment (64 bytes)
	u8 dummy_array[32];
...
typedef struct synopGMACDeviceStruct      
{
  ...
  //u8 *TxBuffer;		// jay hsu : malloc a buffer in driver to store skb data. Alloc at init function, free at exit function.
  
  spinlock_t		tx_lock;		// jay hsu @ 20100727 : add tx lock support
...
enum MiiRegisters
{
  ...
  PHY_CBL_DIAG_REG	    = 0x001c,		/*Cable diagnostic registers*/
    PHY_CONTRL_1_REG		= 0x001e,		// jay hsu : Micrel 10/100Mbps phy
  PHY_CONTRL_2_REG		= 0x001f,		// jay hsu : Micrel 10/100Mbps phy
};
...
enum Mii_GEN_STATUS
{
	Mii_100BaseT4		 = 0x8000,		// jay hsu : T4 capable
	Mii_100BaseTX_Full   = 0x4000,		// jay hsu : 100M full
	Mii_100BaseTX_Half   = 0x2000,		// jay hsu : 100M half
	Mii_10BaseT_Full     = 0x1000,		// jay hsu : 10M full
	Mii_10BaseT_Half     = 0x0800,		// jay hsu : 10M half
...
enum InitialRegisters
{
  ...
  DmaBusModeInit         = DmaFixedBurstEnable |   DmaBurstLength8   | DmaDescriptorSkip6       | DmaResetOff,
...
// jay hsu : system board dependent functions
