...
// for cdc eem debug
#define GHWCFG1							HSOTG_REG(0x044)
#define GHWCFG1_epdir					(0xffffffff)

#define GHWCFG2							HSOTG_REG(0x048)
#define GHWCFG2_OTG_ENABLE_IC_USB		(0x1 << 31)
#define GHWCFG2_TknQDepth				(0xf << 26)
#define GHWCFG2_PTxQDepth				(0x3 << 24)
#define GHWCFG2_NPTxQDepth				(0x3 << 22)
#define GHWCFG2_MultiProcIntrpt			(0x1 << 20)
#define GHWCFG2_DynFifoSizing			(0x1 << 19)
#define GHWCFG2_PerioSupport			(0x1 <<	18)
#define GHWCFG2_NumHstChnl				(0xf << 14)
#define GHWCFG2_NumDevEps				(0xf << 10)
#define GHWCFG2_FSPhyType				(0x3 << 8)
#define GHWCFG2_HSPhyType				(0x3 << 6)
#define GHWCFG2_SingPnt					(0x1 << 5)
#define GHWCFG2_OtgArch					(0x3 << 3)
#define GHWCFG2_OtgMode					(0x7 << 0)

#define GHWCFG3							HSOTG_REG(0x04C)
#define GHWCFG3_DfifoDepth				(0xffff << 16)
#define GHWCFG3_OTG_ENABLE_LPM			(0x1 << 15)
#define GHWCFG3_OTG_BC_SUPPORT			(0x1 << 14)
#define GHWCFG3_OTG_ENABLE_HSIC			(0x1 << 13)
#define GHWCFG3_OTG_ADP_SUPPORT			(0x1 << 12)
#define GHWCFG3_RstType					(0x1 << 11)
#define GHWCFG3_OptFeature				(0x1 << 10)
#define GHWCFG3_VndctlSupt				(0x1 << 9)
#define GHWCFG3_I2CIntSel				(0x1 << 8)
#define GHWCFG3_OtgEn					(0x1 << 7)
#define GHWCFG3_PktSizeWidth			(0x7 << 4)
#define GHWCFG3_XferSizeWidth			(0xf << 0)

#define GHWCFG4							HSOTG_REG(0x050)
#define GHWCFG4_ScatterGatherDMA		(0x1 << 31)
#define GHWCFG4_ScatterGatherDMAconfig	(0x1 << 30)
#define GHWCFG4_INEps					(0xf << 26)
#define GHWCFG4_DedFifoMode				(0x1 << 25)
#define GHWCFG4_SessEndFltr				(0x1 << 24)
#define GHWCFG4_BValidFltr				(0x1 << 23)
#define GHWCFG4_AValidFltr				(0x1 << 22)
#define GHWCFG4_VBusValidFltr			(0x1 << 21)
#define GHWCFG4_IddgFltr				(0x1 << 20)
#define GHWCFG4_NumCtlEps				(0xf << 16)
#define GHWCFG4_PhyDataWidth			(0x3 << 14)
#define GHWCFG4_EnabHiber				(0x1 << 6)
#define GHWCFG4_AhbFreq					(0x1 << 5)
#define GHWCFG4_EnablePartialPowerDown	(0x1 << 4)
#define GHWCFG4_NumDevPerioEps			(0xf << 0)

#define GDFIFOCFG						HSOTG_REG(0x05C)
#define GDFIFOCFG_EPInfoBaseAddr		(0xffff << 16)
#define GDFIFOCFG_GDFIFOCfg				(0xffff << 0)

#define DTHRCTL							HSOTG_REG(0x830)
#define DTHRCTL_ArbPrkEn				(0x1 << 27)
#define DTHRCTL_TxThrLen				(0x1ff << 17)
#define DTHRCTL_RxThrEn					(0x1 << 16)
#define DTHRCTL_AHBThrRatio				(0x3 << 11)
#define DTHRCTL_ISOThrEn				(0x1 << 1)
#define DTHRCTL_NonISOThrEn				(0x1 << 0)

#define DIEPTXF(_a)						HSOTG_REG(0x104 + ((_a) * 0x04))
#define DIEPTXF_INEPnTxFDep				(0xffff << 16)
#define DIEPTXF_INEPnTxFStAddr			(0xffff << 0)
