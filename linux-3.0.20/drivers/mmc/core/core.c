...
#if defined(CONFIG_MMC_TIMEOUT) && defined(CONFIG_ARCH_CCEP)
...
static int mmc_rescan_try_freq(struct mmc_host *host, unsigned freq)
{
	...
	/*
	 * It sends CMD52, CMD5, CMD55 which are not used for eMMC init.
	 * Therefore it is better to skip it for booting time.
	*/
	#if 0
	/*
	...
	/*
	 * 2012 DTV projects do have have dependency with SD 2.0.
